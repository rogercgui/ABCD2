...
header('Content-Type: text/text; charset=".$meta_encoding."');
header("Expires: 0");
...
foreach ($seleccion as $base=>$value){
	...
	//$lista_mfn.="/,";
	$query = "&base=".$base."&cipar=$db_path".$actparfolder."/$base".".par&Seleccionados=$lista_mfn&Opcion=seleccionados&lang=".$lang;
	//echo $query;//die;
