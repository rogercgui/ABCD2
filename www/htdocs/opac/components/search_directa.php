...
if (!isset($mostrar_libre) or $mostrar_libre != "N") {
    ?>
    <div id="search">
        <form method="GET" action="buscar_integrada.php" name="directa">
            ...
            if (isset($_REQUEST['Expresion'])) $_REQUEST['Expresion'] = urldecode(str_replace('~', '', $_REQUEST['Expresion']));
            ?>
            <div class="row g-3">
                <div class="col-md-6">
                    <input class="form-control" type="text" name="Expresion" id="search-text" value="<?php if (isset($_REQUEST['Expresion'])) echo htmlentities($_REQUEST['Expresion']); ?>" placeholder="<?php echo $msgstr["front_search"] ?>  ..." />
                </div>
                <div class="col-md-3">
