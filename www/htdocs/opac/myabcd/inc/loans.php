                        ...
                        <div class="card mb-5 table-responsive">
                            <table class="table table-striped">
                                <tr>
                                    <th><?php echo $msgstr["inventory"]; ?>
                                        <input type="hidden" id="cantrenewalst" name="cantrenewalst"
                                            value="<?php if (isset($dataarr["cantrenewals"])) echo $dataarr["cantrenewals"]; ?>" />/<?php echo $msgstr["operation"]; ?>
                                    </th>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <p><span class="badge text-bg-primary"> <?php echo $loan["copyId"]; ?></span></p>
                                            <button type="button" class="btn btn-primary" id="renew" OnClick="ExecutarRenovacao('<?php echo $loan["copyId"] ?>')">
                                                <?php echo $msgstr["makerenewal"]; ?>
                                            </button>
                                        </td>
                                        ...
                                        <td><?php if (substr($loan["startDate"], -1) == ' ') {
                                            ...
                                            ?></td>
                                        <td><strong><?php if (substr($loan["endDate"], -1) == ' ') {
