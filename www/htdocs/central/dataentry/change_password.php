...
<head profile="http://www.w3.org/2005/10/profile">
	...
	if (isset($arrHttp["login"])) {
		$login_value = $arrHttp["login"];
	}
	$pwd_value = "";
	if (isset($arrHttp["password"])) {
		$pwd_value = $arrHttp["password"];
	}
	?>
</head>
		...
		<div class="loginForm">
			<div class="boxContent">
				<form name=administra action=../common/inicio.php method=post onsubmit="Javascript:Enviar();return false">
					...
					<table>
						<tr>
							<td><label for="user"><?php echo $msgstr["userid"] ?></label></td>
						...
						<tr>
							<td><label for="pwd"><?php echo $msgstr["actualpass"] ?></label></td>
						...
						<tr>
							<td><label for="pwd"><?php echo $msgstr["newpass"] ?></label></td>
							...
							<td><a class="bt-fdt w-8" href="javascript:DisplayPassword('pwd')">
									<i class="far fa-eye"></i> <?php echo $msgstr["ver"] ?></a></td>
						<tr>
							<td colspan=3>
								<?php
								...
								?>
						<tr>
							<td><label for="pwd"><?php echo $msgstr["confirmpass"] ?></label></td>
							<td><input autocomplete="off" type="password" name="confirm_password" id="confirmpwd" value=""
									class="textEntry superTextEntry"
									onfocus="this.className = 'textEntry superTextEntry textEntryFocus'"
									onblur="this.className = 'textEntry superTextEntry';" />
							</td>
							<td><a class="bt-fdt w-8" href="javascript:DisplayPassword('confirmpwd')">
									<i class="far fa-eye"></i> <?php echo $msgstr["ver"] ?></a></td>
						<tr>
							<td>
								<?php
