...
<style>
    /* Estilos Gerais do Formulário Modernizado */
    .settings-container {
        display: flex;
        flex-wrap: wrap;
        gap: 20px;
    ...
    .settings-right {
        flex: 0 0 450px;
        /* Largura fixa para o preview */
    }

    /* Cards de Agrupamento */
    .config-card {
        background: #fff;
...
<div class="middle form row m-0">
    ...
    <div class="formContent col-9 m-2">
        ...
        $opac_gstyle_def = []; // Inicializa vazio

        if (file_exists($opac_global_style_def)) {
            $loaded_conf = parse_ini_file($opac_global_style_def, true);
            if ($loaded_conf) {
                $opac_gstyle_def = $loaded_conf;
            }
        }

        // Mescla os valores carregados com os padrões
        $opac_gstyle_def = array_merge($defaults, $opac_gstyle_def);

        // Extrai variáveis específicas de layout
        ...
        if (isset($opac_gstyle_def['hideFILTER'])) $hide_filter = $opac_gstyle_def['hideFILTER'];
        ?>
            ...
            <div class="settings-container">
                <div class="settings-left">
                    ...
                    <div class="config-card">
                        ...
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_body_bg"]; ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BG" id="cfg_COLOR_BG" value="<?php echo $opac_gstyle_def['COLOR_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#f8f9fa', 'COLOR_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_color_text"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_TEXT" id="cfg_COLOR_TEXT" value="<?php echo $opac_gstyle_def['COLOR_TEXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_TEXT');update(this.jscolor, '#COLOR_TEXT2');update(this.jscolor, '#COLOR_TEXT3')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#4D4D4DFF', 'COLOR_TEXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_color_links"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_LINKS" id="cfg_COLOR_LINKS" value="<?php echo $opac_gstyle_def['COLOR_LINKS']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_LINKS'),update(this.jscolor, '#COLOR_LINKS2'),update(this.jscolor, '#COLOR_LINKS3')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#000000', 'COLOR_LINKS')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="config-card">
                        ...
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_topbar_bg"]; ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_TOPBAR_BG" id="cfg_COLOR_TOPBAR_BG" value="<?php echo $opac_gstyle_def['COLOR_TOPBAR_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_TOPBAR_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_TOPBAR_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_color_topbar"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_TOPBAR_TXT" id="cfg_COLOR_TOPBAR_TXT" value="<?php echo $opac_gstyle_def['COLOR_TOPBAR_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_TOPBAR_TXT');update(this.jscolor, '#COLOR_TOPBAR_TXT2');update(this.jscolor, '#COLOR_TOPBAR_TXT3')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#000000', 'COLOR_TOPBAR_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_bgcolor_search"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_SEARCHBOX_BG" id="cfg_COLOR_SEARCHBOX_BG" value="<?php echo $opac_gstyle_def['COLOR_SEARCHBOX_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_SEARCHBOX_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_SEARCHBOX_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="config-card">
                        ...
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_primary_button_bg"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_PRIMARY_BG" id="cfg_COLOR_BUTTONS_PRIMARY_BG" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_PRIMARY_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_PRIMARY_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#0d6efd', 'COLOR_BUTTONS_PRIMARY_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_primary_button_text"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_PRIMARY_TXT" id="cfg_COLOR_BUTTONS_PRIMARY_TXT" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_PRIMARY_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_PRIMARY_TXT')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_BUTTONS_PRIMARY_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_submit_button_bg"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_SUBMIT_BG" id="cfg_COLOR_BUTTONS_SUBMIT_BG" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_SUBMIT_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_SUBMIT_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#198754', 'COLOR_BUTTONS_SUBMIT_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_submit_button_text"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_SUBMIT_TXT" id="cfg_COLOR_BUTTONS_SUBMIT_TXT" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_SUBMIT_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_SUBMIT_TXT')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_BUTTONS_SUBMIT_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        ...
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_secondary_button_bg"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_SECONDARY_BG" id="cfg_COLOR_BUTTONS_SECONDARY_BG" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_SECONDARY_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_BG'),update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_BG2'),update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_BG3'),update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_BG4')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#6c757d', 'COLOR_BUTTONS_SECONDARY_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_secondary_button_text"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_SECONDARY_TXT" id="cfg_COLOR_BUTTONS_SECONDARY_TXT" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_SECONDARY_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_TXT');update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_TXT2');update(this.jscolor, '#COLOR_BUTTONS_SECONDARY_TXT3')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_BUTTONS_SECONDARY_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_light_button_bg"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_LIGHT_BG" id="cfg_COLOR_BUTTONS_LIGHT_BG" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_LIGHT_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_LIGHT_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#f8f9fa', 'COLOR_BUTTONS_LIGHT_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_light_button_text"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_BUTTONS_LIGHT_TXT" id="cfg_COLOR_BUTTONS_LIGHT_TXT" value="<?php echo $opac_gstyle_def['COLOR_BUTTONS_LIGHT_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_BUTTONS_LIGHT_TXT')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#000000', 'COLOR_BUTTONS_LIGHT_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="config-card">
                        ...
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_results_bg"] ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_RESULTS_BG" id="cfg_COLOR_RESULTS_BG" value="<?php echo $opac_gstyle_def['COLOR_RESULTS_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_RESULTS_BG');update(this.jscolor, '#COLOR_RESULTS_BG2')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_RESULTS_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_footer_bg"]; ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_FOOTER_BG" id="cfg_COLOR_FOOTER_BG" value="<?php echo $opac_gstyle_def['COLOR_FOOTER_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_FOOTER_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#ffffff', 'COLOR_FOOTER_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_footer_text"]; ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_FOOTER_TXT" id="cfg_COLOR_FOOTER_TXT" value="<?php echo $opac_gstyle_def['COLOR_FOOTER_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_FOOTER_TXT')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#000000', 'COLOR_FOOTER_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_totop_bg"]; ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_TOTOP_BG" id="cfg_COLOR_TOTOP_BG" value="<?php echo $opac_gstyle_def['COLOR_TOTOP_BG']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_TOTOP_BG')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#0d6efd', 'COLOR_TOTOP_BG')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                        <div class="color-row">
                            <label><?php echo $msgstr["cfg_totop_icon"]; ?></label>
                            <div class="color-input-group">
                                <input name="cfg_COLOR_TOTOP_TXT" id="cfg_COLOR_TOTOP_TXT" value="<?php echo $opac_gstyle_def['COLOR_TOTOP_TXT']; ?>" data-jscolor="{}" onInput="update(this.jscolor, '#COLOR_TOTOP_TXT')">
                                <button type="button" class="btn-reset" onclick="return resetColor('#FFFFFFFF', 'COLOR_TOTOP_TXT')"><i class="fas fa-eraser"></i></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="config-card" id="layout">
                        ...
                        <div class="form-group-inline">
                            ...
                            <label class="radio-inline"><input type="radio" name="cfg_TOPBAR" value="default" <?php if (isset($topbar) and $topbar == "default") echo " checked" ?>> <?php echo $msgstr["cfg_default"]; ?></label> &nbsp;
                            <label class="radio-inline"><input type="radio" name="cfg_TOPBAR" value="sticky-top" <?php if (isset($topbar) and $topbar == "sticky-top") echo " checked" ?>> <?php echo $msgstr["cfg_fixed"]; ?></label>
                        </div>
                        <hr>
                        <div class="form-group-inline">
                            <label><?php echo $msgstr["cfg_hideFILTER"]; ?></label>
                            <?php if (!isset($hide_filter)) $hide_filter = "Y"; ?>
                            <label class="radio-inline"><input type="radio" name="cfg_hideFILTER" value="Y" <?php if (isset($hide_filter) and $hide_filter == "Y") echo " checked" ?>> Y</label> &nbsp;
                            <label class="radio-inline"><input type="radio" name="cfg_hideFILTER" value="N" <?php if (isset($hide_filter) and $hide_filter == "N") echo " checked" ?>> N</label>
                        </div>
                        <hr>
                        <div class="form-group-inline">
                        ...
                        <div class="layout-options">
                            ...
                            <label class="layout-option">
                                <input type="radio" name="cfg_CONTAINER" value="-fluid" <?php if (isset($container) and $container == "-fluid") echo " checked" ?>>
                                <div>
                                    <img src="/assets/images/opac/layout-container-fluid.png" alt="Fluid">
                                    <span class="layout-label"><?php echo $msgstr["cfg_fluid"]; ?></span>
                                </div>
                            </label>

                            <label class="layout-option">
                                <input type="radio" name="cfg_CONTAINER" value="" <?php if (isset($container) and $container == "") echo " checked" ?>>
                                <div>
                                    <img src="/assets/images/opac/layout-container.png" alt="Default">
                                    <span class="layout-label"><?php echo $msgstr["cfg_container_default"]; ?></span>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="layout-options">
                            ...
                            <label class="layout-option">
                                <input type="radio" name="cfg_SIDEBAR" value="Y" <?php if (isset($sidebar) and $sidebar == "Y") echo " checked" ?>>
                                <div>
                                    <img src="/assets/images/opac/layout-sidebar.png" alt="Sidebar">
                                    <span class="layout-label"><?php echo $msgstr["cfg_show_sidebar"]; ?></span>
                                </div>
                            </label>

                            <label class="layout-option">
                                <input type="radio" name="cfg_SIDEBAR" value="N" <?php if (isset($sidebar) and $sidebar == "N") echo " checked" ?>>
                                <div>
                                    <img src="/assets/images/opac/layout-nosidebar.png" alt="No Sidebar">
                                    <span class="layout-label"><?php echo $msgstr["cfg_hide_sidebar"]; ?></span>
                                </div>
                            </label>

                            <label class="layout-option">
                                <input type="radio" name="cfg_SIDEBAR" value="SL" <?php if (isset($sidebar) and $sidebar == "SL") echo " checked" ?>>
                                <div>
                                    <img src="/assets/images/opac/layout-search-large.png" alt="Wide Search">
                                    <span class="layout-label"><?php echo $msgstr["cfg_wide_search_sidebar"]; ?></span>
                                </div>
                            </label>
                        </div>
...
<script>
    // Configurações padrão do jscolor
    ...
    function update(picker, selector) {
        // Atualiza a cor de preenchimento do SVG
        document.querySelectorAll(selector).forEach(function(el) {
            el.style.fill = picker.toRGBAString();
        });
    };
