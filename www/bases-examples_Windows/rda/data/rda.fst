...
22 0 mpu,(|IS_|v22^a|%|/) 
82 5 '/CL_/',(v82^a/) 
100 5 '/AU_/',(v100^a/),(v700^a/), if a(v100) then (replace(v245^c,'por ', ' ')) fi (v110^a/) 
100 8 '/AU_/',(v100^a/),(v700^a/), if a(v100) then (replace(v245^c,'por ', ' ')) fi, (v110^a/) 
...
960 0 v260^c 
911 5 '/KEY_/', v911 
998 0 mpu,(|TW_|v245^a|%|/) 
998 0 mpu,(|TW_|v245^b|%|/) 
998 8 mpu,'|TW_|'(v245^a|%|/)/, 
998 8 mpu,'|TW_|'(v245^b|%|/)/, 
980 0 mpu,(|OD_|v980^d.8|%|/)
980 0 mpu,(|ODC_|v980^d[1].8|%|/)
980 0 mpu,(|OD_|v980^o|%|/)
980 0 mpu,(|ODC_|v980^o[1]|%|/)
...
998 0 mpu,(|TW_|v100^a|%|/) 
998 8 mpu,'|TW_|'(v100^a|%|/)/, 
998 8 mpu,'|TW_|'(v110^a|%|/)/, 
998 8 mpu,'|TW_|'(v700^a|%|/)/, 
999 0 ('TBO_',REF->copies(L->copies('CN_rda_'v1),(v30/))/) 
